...
import { Mail, Phone, MapPin, MessageSquare, Clock, Shield, CheckCircle2 } from "lucide-react";

export const metadata: Metadata = {
  title: "Contact Us | Kynisto Support & Business Inquiries",
  description: "Get in touch with Kynisto. Contact our customer support team, merchant onboarding desk, or data privacy grievance officer.",
  alternates: {
    canonical: "https://kynisto.in/contact",
  },
};
        ...
        <section className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-md">
          ...
          >
            ...
            <div className="sm:col-span-2 mt-2">
              <button
                type="submit"
                className="px-8 py-3 bg-sky-600 hover:bg-sky-700 text-white font-bold text-sm rounded-xl shadow-md transition-all cursor-pointer"
              >
                Submit Message
              </button>
            </div>
