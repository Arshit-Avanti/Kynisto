...
const modernCleanTechStyles = `
  .site, .healthPage, .productDiscovery {
    ...
    background-image: 
      radial-gradient(circle at 18% 25%, rgba(139, 92, 246, 0.22), transparent 45%),
      radial-gradient(circle at 82% 35%, rgba(255, 87, 34, 0.2), transparent 45%),
      radial-gradient(circle at 50% 65%, rgba(56, 189, 248, 0.14), transparent 55%) !important;
  ...
  .topbar {
    ...
    box-shadow: 0 16px 40px rgba(0, 0, 0, 0.45), 0 0 20px rgba(139, 92, 246, 0.15) !important;
  ...
  .locationPill {
    ...
    box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.5), 0 0 16px rgba(255, 87, 34, 0.25) !important;
    padding: 6px 18px !important;
  }
  .searchBox, .healthSearch, .productIntro form, .categoryTile, .storeCard, .advancedFilters input, .providerGrid article {
  ...
  .heroTitleMassive {
    font-size: clamp(64px, 9.5vw, 110px) !important;
    ...
    filter: drop-shadow(0 0 45px rgba(255, 255, 255, 0.45)) drop-shadow(0 12px 30px rgba(0, 0, 0, 0.8)) !important;
  }
  .heroTaglineExact {
  ...
  .cardLeft {
    left: 8% !important;
    transform: rotate(-10deg) translateY(12px) !important;
    z-index: 1 !important;
    width: 250px !important;
    border: 1px solid rgba(139, 92, 246, 0.35) !important;
    box-shadow: 0 16px 45px rgba(0, 0, 0, 0.65), 0 0 30px rgba(139, 92, 246, 0.25) !important;
  }
  .cardLeft:hover {
    transform: rotate(-4deg) translateY(-6px) scale(1.05) !important;
    z-index: 4 !important;
    border-color: rgba(139, 92, 246, 0.7) !important;
    box-shadow: 0 24px 55px rgba(0, 0, 0, 0.8), 0 0 45px rgba(139, 92, 246, 0.45) !important;
  }
  .cardCenter {
    ...
    background: linear-gradient(145deg, rgba(26, 20, 36, 0.96), rgba(15, 17, 26, 0.96)) !important;
    box-shadow: 0 25px 65px rgba(0, 0, 0, 0.75), 0 0 45px rgba(255, 87, 34, 0.38) !important;
  }
  .cardCenter:hover {
    transform: scale(1.14) translateY(-14px) !important;
    z-index: 5 !important;
    border-color: #FF5722 !important;
    box-shadow: 0 30px 75px rgba(0, 0, 0, 0.85), 0 0 60px rgba(255, 87, 34, 0.55) !important;
  }
  .cardRight {
    right: 8% !important;
    transform: rotate(10deg) translateY(12px) !important;
    ...
    box-shadow: 0 16px 45px rgba(0, 0, 0, 0.65), 0 0 30px rgba(56, 189, 248, 0.25) !important;
  }
  .cardRight:hover {
    transform: rotate(4deg) translateY(-6px) scale(1.05) !important;
    z-index: 4 !important;
    border-color: rgba(56, 189, 248, 0.7) !important;
    box-shadow: 0 24px 55px rgba(0, 0, 0, 0.8), 0 0 45px rgba(56, 189, 248, 0.45) !important;
  }
  .heroCardIcon { font-size: 24px !important; margin-bottom: 6px !important; }
  .heroCardBadge {
  ...
  .liveBadge { background: rgba(34, 197, 94, 0.2) !important; color: #4ade80 !important; }
  .heroCardTitle { font-size: 17px !important; font-weight: 800 !important; color: #FFFFFF !important; margin: 0 0 4px !important; }
  .heroCardDesc { font-size: 12px !important; color: rgba(255, 255, 255, 0.7) !important; margin: 0 !important; }
  .heroCardProgress { height: 4px !important; background: rgba(255, 255, 255, 0.1) !important; border-radius: 9999px !important; margin-top: 14px !important; overflow: hidden !important; }
  .heroCardProgress span { display: block !important; height: 100% !important; background: linear-gradient(90deg, #8b5cf6, #38bdf8) !important; border-radius: 9999px !important; }
  .heroCardStatusRow { display: flex !important; justify-content: space-between !important; font-size: 11px !important; color: rgba(255, 255, 255, 0.8) !important; margin-top: 12px !important; padding-top: 10px !important; border-top: 1px solid rgba(255, 255, 255, 0.1) !important; }
  .heroCardStatusRow b { color: #FF5722 !important; }
  .heroCardMiniGrid { display: flex !important; gap: 12px !important; margin-top: 12px !important; font-size: 11px !important; color: rgba(255, 255, 255, 0.8) !important; }
  .heroCardMiniGrid b { color: #38bdf8 !important; }
  @media (max-width: 768px) {
    .overlappingCardsContainer { flex-direction: column !important; position: static !important; gap: 16px !important; min-height: auto !important; }
    .cardLeft, .cardCenter, .cardRight { position: static !important; transform: none !important; width: 100% !important; max-width: 320px !important; }
  }
  ...
  return (
    <main className={`site theme-${accent} density-${density} mode-${themeMode}`}><style dangerouslySetInnerHTML={{ __html: modernCleanTechStyles }} />
      ...
      <section className="hero" id="top">
        <div className="heroCopy heroCenterWrapper">
          <div className="heroBrandCenter">
            <h1 className="heroTitleMassive">Kynisto</h1>
            <p className="heroTaglineExact">The infrastructure of efficiency.</p>

            {/* 3 Overlapping Dark UI Cards with Soft Glows */}
            <div className="overlappingCardsContainer">
              {/* Left Card: Tilted Left - Loyalty Cards */}
              <div className="heroDarkCard cardLeft">
                <div className="heroCardIcon">💳</div>
                <div className="heroCardBadge">Loyalty</div>
                <h3 className="heroCardTitle">Loyalty Cards</h3>
                <p className="heroCardDesc">Instant rewards & merchant points</p>
                <div className="heroCardProgress">
                  <span style={{ width: "75%" }} />
                </div>
              </div>

              {/* Center Card: Straight & Prominent - Queue Ticket */}
              <div className="heroDarkCard cardCenter">
                <div className="heroCardHeader" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <div className="heroCardIcon mainIcon">🎫</div>
                  <span className="heroCardBadge liveBadge">● Live Queue</span>
                </div>
                <h3 className="heroCardTitle mainTitle">Queue Ticket</h3>
                <p className="heroCardDesc">Token #A-42 · Estimated wait: 4 mins</p>
                <div className="heroCardStatusRow">
                  <span>Status: <b>Active</b></span>
                  <span>Store: <b>DLF Pharmacy</b></span>
                </div>
              </div>

              {/* Right Card: Tilted Right - Dashboard */}
              <div className="heroDarkCard cardRight">
                <div className="heroCardIcon">📊</div>
                <div className="heroCardBadge">Analytics</div>
                <h3 className="heroCardTitle">Dashboard</h3>
                <p className="heroCardDesc">Neighborhood stats & live analytics</p>
                <div className="heroCardMiniGrid">
                  <div><b>100+</b> Places</div>
                  <div><b>20</b> Categories</div>
                </div>
              </div>
            </div>
          </div>
