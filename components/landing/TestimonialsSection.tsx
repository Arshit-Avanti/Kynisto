  ...
  return (
    <section className="py-24">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {reviews.map((r) => (
          <div key={r.name} className="p-7 rounded-2xl bg-slate-900/50 border border-slate-800/80 backdrop-blur-lg flex flex-col justify-between hover:border-slate-700 transition-all">
            <div>
              ...
              <p className="text-sm text-slate-300 italic mb-6 leading-relaxed">"{r.text}"</p>
            </div>
            <div>
